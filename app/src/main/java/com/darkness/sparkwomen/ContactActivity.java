    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addContact.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                sms_cont=contact.getText().toString();

                Contacts cont = new Contacts(sms_cont);
                db = FirebaseDatabase.getInstance();
                reference = db.getReference("Contacts");
                reference.child(sms_cont).setValue(cont);

                Toast.makeText(ContactActivity.this, contact.getText().toString(), Toast.LENGTH_SHORT).show();
